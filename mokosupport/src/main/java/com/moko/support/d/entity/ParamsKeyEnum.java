...
public enum ParamsKeyEnum implements Serializable {
    ...
    KEY_LONG_CONNECTION_CLEAR(0x4D),
    ...
    KEY_LONG_CONNECTION_DATA(0x07),
    KEY_PASSWORD(0x55),
    KEY_FIRMWARE_TYPE(0x57),
    KEY_PRODUCT_DATE(0x5A),
    KEY_RESET_BATTERY(0x5D),
    KEY_BATTERY_PERCENT(0x62),
    KEY_BOARD_TYPE(0x75),
    KEY_SINGLE_PRESS_SUB_EVENTS(0x77),
    KEY_DOUBLE_PRESS_SUB_EVENTS(0x78),
    KEY_LONG_PRESS_SUB_EVENTS(0x79),
    KEY_SINGLE_PRESS_EVENT_SUB_CLEAR(0x7A),
    KEY_DOUBLE_PRESS_EVENT_SUB_CLEAR(0x7B),
    KEY_LONG_PRESS_EVENT_SUB_CLEAR(0x7C),
    ;
