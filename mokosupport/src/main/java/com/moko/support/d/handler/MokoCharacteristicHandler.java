...
public class MokoCharacteristicHandler {
    ...
    public HashMap<OrderCHAR, BluetoothGattCharacteristic> getCharacteristics(final BluetoothGatt gatt) {
        ...
        if (gatt.getService(OrderServices.SERVICE_CUSTOM.getUuid()) != null) {
            ...
            if (service.getCharacteristic(OrderCHAR.CHAR_CLICK_EVENT.getUuid()) != null) {
                final BluetoothGattCharacteristic characteristic = service.getCharacteristic(OrderCHAR.CHAR_CLICK_EVENT.getUuid());
                mCharacteristicMap.put(OrderCHAR.CHAR_CLICK_EVENT, characteristic);
            }
            if (service.getCharacteristic(OrderCHAR.CHAR_LONG_CONNECTION.getUuid()) != null) {
                final BluetoothGattCharacteristic characteristic = service.getCharacteristic(OrderCHAR.CHAR_LONG_CONNECTION.getUuid());
                mCharacteristicMap.put(OrderCHAR.CHAR_LONG_CONNECTION, characteristic);
            }
            if (service.getCharacteristic(OrderCHAR.CHAR_CLICK_SUB_EVENT.getUuid()) != null) {
                final BluetoothGattCharacteristic characteristic = service.getCharacteristic(OrderCHAR.CHAR_CLICK_SUB_EVENT.getUuid());
                mCharacteristicMap.put(OrderCHAR.CHAR_CLICK_SUB_EVENT, characteristic);
            }
        }
