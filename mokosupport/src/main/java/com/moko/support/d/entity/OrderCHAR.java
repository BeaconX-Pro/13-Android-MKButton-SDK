...
public enum OrderCHAR implements Serializable {
    ...
    CHAR_CLICK_EVENT(UUID.fromString("0000AA08-0000-1000-8000-00805F9B34FB")),
    CHAR_LONG_CONNECTION(UUID.fromString("0000AA09-0000-1000-8000-00805F9B34FB")),
    CHAR_CLICK_SUB_EVENT(UUID.fromString("0000AA0A-0000-1000-8000-00805F9B34FB")),
    ;
