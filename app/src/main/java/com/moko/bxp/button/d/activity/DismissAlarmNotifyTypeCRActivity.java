...
public class DismissAlarmNotifyTypeCRActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] dismissAlarmNotifyTypeArray = getResources().getStringArray(R.array.alarm_notify_type_cr);
    ...
    public void onConnectStatusEvent(ConnectStatusEvent event) {
        ...
        runOnUiThread(() -> {
            if (MokoConstants.ACTION_DISCONNECTED.equals(action)) {
                // 设备断开，通知页面更新
                DismissAlarmNotifyTypeCRActivity.this.finish();
            }
        });
    }
                            ...
                            if (flag == 0x01 && length == 0x01) {
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_DISMISS_ALARM:
                                        ...
                                        if (isConfigError) {
                                            ToastUtils.showToast(DismissAlarmNotifyTypeCRActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                        } else {
