...
public class AlarmNotifyTypeCRActivity extends BaseActivity {
    ...
    public void onConnectStatusEvent(ConnectStatusEvent event) {
        ...
        runOnUiThread(() -> {
            if (MokoConstants.ACTION_DISCONNECTED.equals(action)) {
                // 设备断开，通知页面更新
                AlarmNotifyTypeCRActivity.this.finish();
            }
        });
    }
                            ...
                            if (flag == 0x01 && length == 0x01) {
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_SLOT_TRIGGER_ALARM_NOTIFY_TYPE:
                                        ...
                                        if (isConfigError) {
                                            ToastUtils.showToast(AlarmNotifyTypeCRActivity.this, "Opps！Save failed. Please check the input characters and try again.");
                                        } else {
